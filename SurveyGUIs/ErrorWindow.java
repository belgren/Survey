...
/**
 * GUI class that displays an error message when the user does a "bad" action
 * (this class is not fully functional yet) If encountered, the user must
 * re-start the survey making process.
 *
 */
public class ErrorWindow {
	...
	/**
	 * Constructor which takes in an error message that is passed in when a button
	 * is pressed (if something is incorrect)
	 */
	...
	public void initialize() {
		...
		// Displays the appropriate error message (gets passed in when a specific button
		// is pressed)
